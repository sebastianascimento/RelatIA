...
class TaskTest(TestCase):
    def test_task_factory_creates_tasks(self):
        ...
        with patch('analyzer.ai_agents.agents.Ollama'):
            ...
            structure_task = task_factory.create_structure_analysis_task(structure_agent, test_code)
            security_task = task_factory.create_security_analysis_task(security_agent, test_code)
            quality_task = task_factory.create_quality_analysis_task(quality_agent, test_code)
